package com.harsh.usage_service.service;

import com.harsh.kafka.event.AlertingEvent;
import com.harsh.kafka.event.EnergyUsageEvent;
import com.harsh.usage_service.client.DeviceClient;
import com.harsh.usage_service.client.UserClient;
import com.harsh.usage_service.dto.DeviceDto;
import com.harsh.usage_service.dto.UsageDto;
import com.harsh.usage_service.dto.UserDto;
import com.harsh.usage_service.model.Device;
import com.harsh.usage_service.model.DeviceEnergy;
...
public class UsageService {
    ...
    public UsageDto getXDaysUsageForUser(Long userId, int days) {
        ...
        final Instant now = Instant.now();
        final Instant start = now.minusSeconds((long) days * 24 * 360);
